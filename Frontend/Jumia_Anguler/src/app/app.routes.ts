...
export const routes: Routes = [
    {path : '', redirectTo: 'introSellerRegister', pathMatch: 'full'},
    ...
    {path: 'introSellerRegister', loadComponent: () => import('../Components/intro-seller-register/intro-seller-register.component').then((m) => m.IntroSellerRegisterComponent)},
];
